drop function if exists public.save_food_catalog_item_orders(jsonb);
drop function if exists public.save_food_catalog_item_orders(uuid, jsonb);

create function public.save_food_catalog_item_orders(
  p_category_id uuid,
  order_rows jsonb
)
